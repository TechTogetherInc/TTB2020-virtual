  ...
  <section className="footer">
    <div className="row mx-auto align-items-center">
      ...
      <div className="col-4">
        ...
        <br/>
        <p><a href="https://techtogether.io/" target="_blank">About TechTogether</a></p>
      </div>
      ...
      <div className="col-4 social-media">
        ...
        <a className="sm-icons" href="https://www.youtube.com/channel/UCRfTWuC55dbE4koLsIjH5bA" target="_blank"><img
                                src={Youtube} alt="Youtube Logo" /></a>  
        <a className="sm-icons" href="mailto:info.boston@techtogether.io" target="_blank"><img
                                src={Email} alt="Email Logo" /></a>
